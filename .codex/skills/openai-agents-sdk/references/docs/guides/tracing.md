...
By default, the trace is named "Agent workflow". You can set this name if you use `withTrace`, or you can configure the name and other properties with the [`RunConfig.workflowName`](/openai-agents-js/openai/agents-core/type-aliases/runconfig/#workflowname).
